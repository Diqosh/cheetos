...
export const Main = () => {
  return (
    <div className="flex flex-col justify-center items-center min-h-2/3 relative overflow-hidden">
      <HeartAnimation />
      ...
      >
        ...
        {/* Cheetos bags with responsive positioning */}
        <CheetosBag
          image={cheetosBlack}
          className="
            right-0
            translate-x-[30%] md:translate-x-[40%]
            -translate-y-[20%] md:-translate-y-[25%]
            rotate-[20deg]"
        />
